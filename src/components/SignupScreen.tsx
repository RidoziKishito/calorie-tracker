...
export function SignupScreen({ navigateTo, updateUserProfile }: SignupScreenProps) {
  ...
  return (
    <div className="screen-container bg-light">
      <div className="screen-header">
        ...
        <h5 className="screen-title mb-0">Đăng ký</h5>
      ...
      <div className="p-4 fade-in">
        <div className="text-center mb-4 mt-3">
          ...
          <p className="text-muted">Bắt đầu hành trình sức khỏe của bạn</p>
        </div>
        ...
        <div className="text-center mt-4">
          ...
          <a href="#" className="text-decoration-none" onClick={(e) => { e.preventDefault(); navigateTo('login'); }}>
            Đăng nhập
          </a>
        </div>
      </div>
